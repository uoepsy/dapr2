...
## From last week: Dealing with influential cases


---
##  What should be done when we identify issues with model diagnostics?
...
---
## Issues with Linear Models: Violated Assumptions
...
+ Usually detected by observing violations of linearity, normality of residuals or heteroscedasticity
  + Solved by including additional terms in our linear model

---
## Atypical Distributions
+ We may also see non-normal residuals, heteroscedasticity and/or non-linearity due to distributional issues with our model variables
...
.pull-right[
+ This process allows us to get an estimate of the sampling variability, **but is the process realistic?**
    
+ Do I really want to repeat the sampling 500 times?
    + Probably not...
{{content}}    
]
...
> **Test your understanding:** In a study, we took a sample of 35 DapR2 students and calculated their mean scores on the exam. We want to use bootstraping. What will our resample $n$ be? What will our resample statistic be? 
...
+ Let's re-scale `height` to be in centimetres, mean-centre it,  and re-run the model
