...
Your report will be **marked based on four criteria**: the quality of each of the three sections—(1) analysis strategy; (2) results; (3) discussion—as well as (4) writing and formatting. The associated grade percentages are shown in parentheses below. 
...
### 4. Writing & Formatting (10%)

The body of your report (i.e., everything except the appendix) should be a **maximum of four sides of A4** when the default formatting and font settings within RStudio are used when knitting your file.
...
- The body of the report (excluding the appendix) is a maximum of 4 pages long when you use RStudio's default formatting and font settings. Specifically, this means:
  - In PDF form, four pages.
  - If printed single-sided, four physical sheets of paper.
  - If printed double-sided, two physical sheets of paper.
