...
<nav id="menu">
  ...
  <ul>
    ...
    <li><a href="https://uoepsy.github.io/ap">Applied Psychometrics</a></li>
		<li><a href="https://uoepsy.github.io/scs">Short Courses</a></li>
...
buttonarchive = function(c,ay){
  paste0('<button class="button" onclick="window.location.href=\'https://uoepsy.github.io/', c,'/',ay,'/index.html\'">',paste0("20",substr(ay,1,2),"/",substr(ay,3,4)),' Archive</button>')
}
