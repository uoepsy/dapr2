...
<!-- Here's a plot that shows the associations between the variables we're interested in. -->
<!-- (Don't worry about the code that generates this plot unless you want to.) -->
...
<!--     zn_bin = cut( -->
<!--       zn,  -->
<!--       breaks = c( min(zn), mean(zn) - sd(zn), mean(zn), mean(zn) + sd(zn), max(zn) ), -->
<!--       include.lowest = TRUE, -->
<!--       labels = c( 'zn,\n from min \nto mean – 1 SD', 'zn,\n from mean – 1 SD \nto mean', 'zn,\n from mean \nto mean + 1 SD', 'zn,\n from mean + 1 SD \nto max' ) -->
<!--     ) -->
<!--   ) |> -->
<!--     ggplot(aes(x = scs, y = dass)) + -->
<!--     facet_wrap(~zn_bin, nrow = 1) + -->
<!--     geom_point() + -->
