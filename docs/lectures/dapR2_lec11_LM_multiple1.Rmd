...
+ **Controlling for self-control, for every SD unit increase in rating of class interaction, there is a `r round(res$coefficients[[3,1]],2)` SD unit increase in academic performance**
...
+ As the sample size is large and the number of predictors small, adjusted ( `r round(res$r.squared,3)` ) and unadjusted R-squared ( `r round(res$adj.r.squared,3)` ) are similar.
