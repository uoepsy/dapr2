...
tab_model(m1, 
          pred.labels = c('Intercept', 'Study-Minimal', 'Study-Moderate', 'Study-Extensive', 'Medium-Longhand', 
                          'Study-Minimal : Medium-Longhand', 'Study-Moderate : Medium-Longhand', 'Study-Extensive : Medium-Longhand'),
