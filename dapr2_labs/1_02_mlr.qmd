...
Much of the information required can be found in the [Study Overview] codebook. The [statistical models](https://uoepsy.github.io/dapr2/2526/labs/1_b1_reading.html#statistical-models) flashcards may also be useful to refer to. 
...
For examples, see flashcards on [descriptives statistics tables](https://uoepsy.github.io/dapr2/2425/labs/1_b4_reading.html#data-exploration) and [data visualisation - marginal](https://uoepsy.github.io/dapr2/2526/labs/1_b1_reading.html#visual-exploration).
...
Review how to visually explore bivariate associations via the [data visualisation flashcards](https://uoepsy.github.io/dapr2/2526/labs/1_b1_reading.html#visual-exploration). 

For specifically visualising associations between variables, see the [bivariate examples flashcards](https://uoepsy.github.io/dapr2/2526/labs/1_b1_reading.html#visual-exploration). 
...
Review the [correlation flashcards](https://uoepsy.github.io/dapr2/2526/labs/1_b1_reading.html#correlation), and remember to interpret in the context of the research question. 
...
As we did for simple linear regression, we can fit our multiple regression model using the `lm()` function. For a recap, see the [statistical models flashcards](https://uoepsy.github.io/dapr2/2526/labs/1_b1_reading.html#statistical-models). 
...
To interpret and extract information, see the [simple & multiple regression models - extracing information flashcards](https://uoepsy.github.io/dapr2/2526/labs/1_b1_reading.html#statistical-models)
...
Either `sigma()` or part of the output from `summary()` will help you here. See [Lab 1 Q5](https://uoepsy.github.io/dapr2/2526/labs/1_01_slr.html) for an example, or the [simple & multiple regression models - extracting information flashcard](https://uoepsy.github.io/dapr2/2526/labs/1_b1_reading.html#statistical-models).  
...
It might be helpful to review the [predicted values > model predicted values for other (unobserved) data](https://uoepsy.github.io/dapr2/2526/labs/1_b1_reading.html#model-predicted-values-residuals).
...
Use `tab_model()` from the **sjPlot** package. For a quick guide, review the [tables flashcard](https://uoepsy.github.io/dapr2/2526/labs/1_b1_reading.html#tables). 
