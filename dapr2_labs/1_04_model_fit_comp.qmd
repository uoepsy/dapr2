...
+ `model2` vs `model6`  
  These models are nested, but they are __not__ fitted on the same dataset. `model2` uses the 'mwdata' dataset, whilst `model6` uses the 'wb_data' dataset. We cannot compare these models.   
