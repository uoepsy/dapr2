...
For a recap, see the [statistical models flashcards](https://uoepsy.github.io/dapr2/2425/labs/1_b3_reading.html#statistical-models), specifically the multiple linear regression models - description & specification card. 
...
For a more detailed overview, see the [R-squared and Adjusted R-squared flashcard](https://uoepsy.github.io/dapr2/2425/labs/1_b3_reading.html#model-fit). 
...
Think about when you would report $R^2$ and Adjusted-$R^2$ - the [R-squared and Adjusted R-squared flashcard](https://uoepsy.github.io/dapr2/2425/labs/1_b3_reading.html#model-fit) has some detail on this, but it will also be useful to think about how each is calculated. 
...
See the [F-ratio flashcard](https://uoepsy.github.io/dapr2/2425/labs/1_b3_reading.html#model-fit) for a more detailed overview. 
...
We can fit our multiple regression models individually using the `lm()` function. For a recap, see the [statistical models flashcards](https://uoepsy.github.io/dapr2/2425/labs/1_b3_reading.html#statistical-models), specifically the multiple linear regression models - description & specification card.  
...
When considering what method(s) you can use to compare the models, remember to determine whether the models are [nested or non-nested](https://uoepsy.github.io/dapr2/2425/labs/1_b3_reading.html#model-comparisons).

You can use **KableExtra** to present your model comparison results in a well formatted table. For a quick guide, review the [tables flashcard](https://uoepsy.github.io/dapr2/2425/labs/1_b3_reading.html#tables).
...
Are the models are [nested or non-nested](https://uoepsy.github.io/dapr2/2425/labs/1_b3_reading.html#model-comparisons)? This will impact what method(s) you can use to compare the models. 
...
[This flowchart](https://uoepsy.github.io/dapr2/2425/labs/1_b3_reading.html#model-comparisons) might help you to reach your decision.
