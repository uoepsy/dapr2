...
4. Check coding of variables (e.g., that catgorical variables are coded as factors)
...
The researchers have decided that they would prefer 'routine' to be considered the reference level for the "routine" variable instead of 'no routine'. Apply this change to the variable and re-run your model.
...
```{r}
#re-order so that routine is reference level
