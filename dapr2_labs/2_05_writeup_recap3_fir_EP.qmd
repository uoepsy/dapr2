...
In the No and Minimal study conditions, there did not appear to be differences in test score between participants using a laptop or longhand when note-taking.
However, participants in the longhand note-taking condition scored higher than those using laptops in the moderate and extensive study conditions.
This suggested that there may be an interaction (see @fig-notes-plot). 
...
Specifically, we found that people who did not study performed at chance level, regardless of note-taking medium.
However, when people studied any amount, then those people who took longhand notes performed better than people who took notes on a laptop.
Our results suggest that using a laptop to take notes may not set learners up for as much success, and that engaging in more hours of study is not enough to mitigate this effect.
