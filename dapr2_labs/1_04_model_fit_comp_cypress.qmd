...
1. Understand how to calculate the interpret $R^2$ and $\hat R^2$ as a measure of model quality.
...
To review how to calculate, extract, and interpret $R^2$ and $\hat R^2$ values, see the [model fit > linear models > R-squared and Adjusted R-squared flashcard](https://uoepsy.github.io/dapr2/2526/labs/1_b1_reading.html#linear-models).
