...
Relative to those who never intend to quit, reporting an intention to quit but not in the next 6 months was associated with ($OR = `r res[2,1]`,\,\, 95\%\, CI\, [`r paste(res[2,2:3],collapse=", ")`]$) increased odds of attempting to quit. 
