...
2. Have completed previous lab exercises from [Week 1](https://uoepsy.github.io/dapr2/2526/labs/2_01_int1_nc.html) and [Week 2](https://uoepsy.github.io/dapr2/2526/labs/2_02_int2_nn.html)  
...
> Specifically, the researchers want to test a hypothesised theory according to which the difference in performance between explicit and implicit memory tasks will be greatest for Huntington patients in comparison to controls. On the other hand, the difference in performance between explicit and implicit memory tasks will not significantly differ between patients with amnesia in comparison to controls.
...
For a specific example of coefficient interpretation, review the [interaction models > categorical x categorical example > results interpretation flashcards](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#categorical-x-categorical-example).  
...
plt_cog_mdl3 <- cat_plot(model = cog_mdl, 
                  pred = Diagnosis, 
                  modx = Task, 
                  geom = "line",
                  interval = T, 
...
For an example of coefficient interpretation, review the [interaction models > categorical x categorical example > results interpretation flashcards](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#categorical-x-categorical-example). 
