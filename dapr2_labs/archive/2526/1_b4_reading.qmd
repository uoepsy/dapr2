...
`r optbegin("Effect Size: Cohen's Guidelines",olabel=FALSE,toggle=params$TOGGLE)`

Cohen (1988) provided guidelines for what a small, medium, or large effect typically is in the behavioral sciences.
