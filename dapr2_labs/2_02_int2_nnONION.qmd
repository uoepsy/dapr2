...
& + \beta_3 \cdot (\text{SCS Score} \cdot \text{Neuroticism}) + \epsilon
\end{align}
$$ 
...
For an overview of how to interpret coefficients, review the [interaction models > interpreting coefficients flashcard](https://uoepsy.github.io/dapr2/2425/labs/1_b3_reading.html#interaction-models).  
