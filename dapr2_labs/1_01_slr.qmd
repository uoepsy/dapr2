...
For examples of mariginal distrubtion visualisation examples, see the [data visualisation - marginal examples flashcards](https://uoepsy.github.io/dapr2/2425/labs/1_b2_reading.html#visual-exploration).
...
See the [statistical models flashcards](https://uoepsy.github.io/dapr2/2425/labs/1_b2_reading.html#statistical-models) for a reminder on how to specify models. 

For how to format and write your model in RMarkdown, see the [LaTeX symbols and equations flashcard](https://uoepsy.github.io/dapr2/2425/labs/1_b2_reading.html#latex-symbols-equations). 
...
The term "Residual standard error" is a misnomer, as the help page for `sigma` says (check `?sigma`). However, it's hard to get rid of this bad name as it has been used in too many books showing R output. For more information, check the [simple & multiple regression models - extracting information flashcard](https://uoepsy.github.io/dapr2/2425/labs/1_b2_reading.html#statistical-models) flashcard. 
...
For further `ggplot()` guidance, see the [how to visualise data flashcard](https://uoepsy.github.io/dapr2/2425/labs/1_b2_reading.html#data-exploration). 
...
For a more detailed description and worked example, check the [model predicted values & residuals flashcards](https://uoepsy.github.io/dapr2/2425/labs/1_b2_reading.html#model-predicted-values-residuals).
