...
This is done in R by fitting the model

$$
y = \beta_0 + \beta_1 \ E_{1} + \beta_2 \ E_{2} + \epsilon \\
$$
...
0 & \text{if observation is from category 3} \\
-1& \text{otherwise} \\
\end{cases}
$$
...
- $\beta_0 = \mu$ is the overall mean
- $\beta_1 = \mu_1 - \mu$ is the effect of level 1
- $\beta_2 = \mu_2 - \mu$ is the effect of level 2
- $\beta_3$ is not shown by the linear model as it is found by $ - \beta_1 - \beta_2 $
...
$$
y = \beta_0 + \beta_2 \ D_{2} + \beta_3 \ D_{3} + \epsilon \\
$$
...
\qquad
D_3 = \begin{cases}
1 & \text{if observation is from category 3} \\
0 & \text{otherwise}
\end{cases}
$$
...
- $\beta_0 = \mu_1$ is the mean of the base level (level 1)
- $\beta_2 = \mu_2 - \mu_1$ is the effect of level 2
- $\beta_3 = \mu_3 - \mu_1$ is the effect of level 3
- $\beta_1$ is not shown by the linear model as it is set to 0 by the constraint
