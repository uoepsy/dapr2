...
:::red
These exercises cover this week's and next week's lecture material. So take this lab slowly, try to understand it and don't rush through it as it is important material.

You will also have next week to work through these exercises.
:::
...
mdl <- lm(amount ~ 1 + type, data = rest_spend) # or: lm(amount ~ type, data = rest_spend)
summary(mdl)
```
...
- $b_0$ is estimated overall mean
- $b_1$ is the effect of Classical Music
- $b_2$ is the effect of No Music
- **NOTE**: The effect of Pop Music is not shown by `summary` as it is found via the side-constraint as `-(b_1 + b_2)`!
...
- $b_0$ is the mean of the base level (level 1)
- $b_1$ is the effect of No Music
- $b_2$ is the effect of Pop Music
