...
`r optbegin("Caffeine Codebook", olabel=FALSE,toggle=params$TOGGLE)`  
...
See the [numeric outcomes & categorical predictors flashcards](https://uoepsy.github.io/dapr2/2526/labs/1_b2_reading.html#numeric-outcomes-categorical-predictors), specifically 'specifying reference levels'.
...
For examples, see flashcards on [descriptives statistics tables](https://uoepsy.github.io/dapr2/2526/labs/1_b2_reading.html#descriptives) and [data visualisation > marginal distributions - examples flashcard](https://uoepsy.github.io/dapr2/2526/labs/1_b2_reading.html#visual-exploration), paying particular attention to the type of data that you're working with.
...
We can fit multiple regression models with categorical predictors using the `lm()` function. For a recap, see the [ description & model specification](https://uoepsy.github.io/dapr2/2526/labs/1_b2_reading.html#numeric-outcomes-categorical-predictors) flashcards. 
...
4. Reference Groups = Diagnosis - Control; Task - Recognition. Selecting the Control group as the reference for Diagnosis allows for the assessment of memory deficits in both patient groups against the typical functioning of participants without cognitive impairments (i.e., individuals in this group provide a baseline of normal memory function related to both explicit and implicit memory tasks). By using Recognition as the reference for Task, the model can assess how performance on the Grammar and Classification tasks (representing implicit memory) differs from performance in explicit tasks across different groups.
