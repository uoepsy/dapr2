...
For examples, see flashcards on [descriptives statistics tables - categorical and numeric values examples](https://uoepsy.github.io/dapr2/2425/labs/1_b1_reading.html#data-exploration) and [data visualisation - bivariate examples](https://uoepsy.github.io/dapr2/2425/labs/1_b1_reading.html#visual-exploration), paying particular attention to the type of data that you're working with.
...
We can fit our multiple regression model using the `lm()` function. For a recap, see the [statistical models flashcards](https://uoepsy.github.io/dapr2/2425/labs/1_b1_reading.html#statistical-models). 
