...
4. Reference Groups = Sleep Condition - Non-Sleep Deprived because the research question stated that the researchers were interested in how the sleep deprived group *differed from* the non-sleep deprived group. 
...
4. Reference Groups = Task - A because the research question stated that the researchers were interested in how response time in Task B *differed from* the response time in Task A. 
