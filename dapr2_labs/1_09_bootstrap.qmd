...
The `ebsurvey` dataset, excluding missing values, included 10,503 individual respondents who were measured on 3 different attributes: (1) Score on a science "quiz" composed of 13 true/false items; (2) Attitudes towards science and faith (question wording: "We rely too much on science and not enough on faith"; responses on a 5-point scale from strongly disagree to strongly agree); and (3) their age (measured in years).

Histograms will be used to visualise the marginal distributions of XXXXXXX. To understand the strength of association among the variables, we will estimate the the correlation coefficients. To address the research question of whether there is an association between XXXXX after taking into account the association between XXX and age, we are going to fit the following multiple linear regression model:
...
$H_0: \beta_1 = 0$: There is no association between wellbeing and time spent outdoors after taking into account the association between wellbeing and age

$H_1: \beta_1 \neq 0$: There is an association between wellbeing and time spent outdoors after taking into account the association between wellbeing and age
...
+ There was a weak, negative, linear association between attitude towards science and faith and scientific knowledgefor the participants in the sample ($r$ = -.18)
...
+ Overall, there are very weak linear associations among the variables of interest
...
You can use your preferred confidence level here, by default this is 95%:
