...
We notice a moderate, positive, linear relationship between height and handspan. The marginal boxplots do not highlight the presence of outliers in the data.
`r solend()`
...
A statistical model includes **both** a linear function and a random error term:
$$
