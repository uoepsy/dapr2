...
B) Use R and RStudio online via RStudio Cloud in a web browser (for people using Chromebooks).

:::red
**If you encounter any problems during the installation of R or RStudio, please try to use RStudio Cloud (option B)**
:::
...
1. Rename the project from *Untitled Project* to *dapr1*
...
1. __EITHER:__
    ...
    + Option B: Register for RStudio Cloud (free) and log in &emsp; &#10004;
