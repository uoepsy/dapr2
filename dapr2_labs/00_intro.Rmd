...
`r optbegin("Option B: RStudio PPLS Server",olabel=FALSE)`

0. Fill out the form [here](https://forms.office.com/Pages/DesignPage.aspx?origin=OfficeDotCom&lang=en-GB#FormId=sAafLmkWiUWHiRCgaTTcYTstBwJEBklLhOSskzRST95UMTFKQlo5NkdOS0RNRTVXQjZLWloyU1RPQS4u) to register for access. You will receive an email when it has been granted.  
