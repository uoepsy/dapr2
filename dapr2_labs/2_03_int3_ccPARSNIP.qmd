...
For a specific example of coefficient interpretation, review the [interaction models > categorical x categorical example > results interpretation flashcards](https://uoepsy.github.io/dapr2/2425/labs/1_b3_reading.html#categorical-x-categorical-example).  
...
For an example of coefficient interpretation, review the [interaction models > categorical x categorical example > results interpretation flashcards](https://uoepsy.github.io/dapr2/2425/labs/1_b3_reading.html#categorical-x-categorical-example). 
