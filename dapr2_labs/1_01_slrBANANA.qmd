...
For examples of mariginal distrubtion visualisation examples, see the [data visualisation - marginal examples flashcards](https://uoepsy.github.io/dapr2/2425/labs/1_b1_reading.html#visual-exploration).
...
*Plot*  
We are trying to investigate how wellbeing varies by varying numbers of weekly social interactions. Hence, wellbeing is the dependent variable (on the y-axis), and social interactions is the independent variable (on the x-axis). Checking the [bivariate examples flashcard](https://uoepsy.github.io/dapr2/2425/labs/1_b1_reading.html#visual-exploration) might help. 

*Correlation*  
Have a look at [this set of flashcards](https://uoepsy.github.io/dapr2/2425/labs/1_b1_reading.html#correlation) for all things correlation. Remember to round your numbers in-line with [APA 7th edition guidelines](https://uoepsy.github.io/dapr2/2425/labs/1_b1_reading.html#apa-formatting). The `round()` function will come in handy here.
...
See the [statistical models flashcards](https://uoepsy.github.io/dapr2/2425/labs/1_b1_reading.html#statistical-models) for a reminder on how to specify models. 
  
For how to format and write your model in RMarkdown, see the [LaTeX symbols and equations flashcard](https://uoepsy.github.io/dapr2/2425/labs/1_b1_reading.html#latex-symbols-equations). 
...
The term "Residual standard error" is a misnomer, as the help page for `sigma` says (check `?sigma`). However, it's hard to get rid of this bad name as it has been used in too many books showing R output. For more information, check the [simple & multiple regression models - extracting information flashcard](https://uoepsy.github.io/dapr2/2425/labs/1_b1_reading.html#statistical-models) flashcard. 
...
For further `ggplot()` guidance, see the [how to visualise data flashcard](https://uoepsy.github.io/dapr2/2425/labs/1_b1_reading.html#data-exploration). 
...
For a more detailed description and worked example, check the [model predicted values & residuals flashcards](https://uoepsy.github.io/dapr2/2425/labs/1_b1_reading.html#model-predicted-values-residuals).
