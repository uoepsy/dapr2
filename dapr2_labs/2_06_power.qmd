...
> **Research Question**
>  
> Does the association between recall and age differ by intervention type?
...
$$
\begin{aligned}
&\text{Recall} = \beta_0 + \beta_1 \cdot \text{Age}  + \beta_2 \cdot \text{Intervention Group}_{\text{Meditation}} \\
&  \quad \quad \quad+ \beta_3 \cdot (\text{Age} \cdot \text{Intervention Group}_{\text{Meditation}}) + \epsilon
\end{aligned}
$$
...
For examples, see flashcards on [descriptives statistics tables - categorical and numeric values examples](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#descriptives) and and [data visualisation - bivariate examples](https://uoepsy.github.io/dapr2/2526/labs/1_b4_reading.html#visual-exploration), paying particular attention to the type of data that you're working with.
...
Either a boxplot **or** violin plot would be most appropriate for visualisations:
...
```{r}
ggplot(data = recdata, aes(x = group, y = perc_recall, fill = group, colour = group)) +
...
For a recap on how to create a scatterplot, review the [data visualisation - bivariate examples](https://uoepsy.github.io/dapr2/2526/labs/1_b4_reading.html#visual-exploration).
...
Review the following flashcards on [statistical power & effect size](https://uoepsy.github.io/dapr2/2526/labs/1_b4_reading.html#statistical-power-effect-size), paying particular attention to the following two flashcards - *Effect Size: Cohen's Guidelines* and *Power for Linear Regression*. 
...
For a recap on how to specify a simple linear model, review the [statistical models flashcards](https://uoepsy.github.io/dapr2/2526/labs/1_b4_reading.html#statistical-models). 

The proportion of the total variability explained is given by $R^2$. For a more detailed overview, see the [R-squared and Adjusted R-squared flashcard](https://uoepsy.github.io/dapr2/2526/labs/1_b4_reading.html#model-fit). 
...
Review the following flashcards on [statistical power & effect size](https://uoepsy.github.io/dapr2/2526/labs/1_b4_reading.html#statistical-power-effect-size), paying particular attention to the following two flashcards - *The pwr Package* and *Power for Linear Regression*. 
...
With such a big effect size (*n.b., which you are highly unlikely to observe in a real study*), don't be surprised it's so small. When the effect size is much smaller, that will be harder to detect and you will require a bigger sample size.
...
Suppose that the aforementioned researcher made a mistake, and issues a corrected statement in which they state that the inclusion of intervention group and its interaction with age should explain an extra 5%  (not 50%) of the variation in recall scores.
...
Review the following flashcards on [statistical power & effect size](https://uoepsy.github.io/dapr2/2526/labs/1_b4_reading.html#statistical-power-effect-size), paying particular attention to the following flashcard *Factors Affecting Power*. 
