...
In this lab, you'll practice fitting and interpreting a logistic regression model with three continuous predictors.
...
Our model will estimate the log-odds of an individual displaying PSMU as a function of their Machiavellianism, their psychopathy, and their narcissism (all z-scored).
...
For each coefficient in the model summary, write one sentence to interpret its meaning.
