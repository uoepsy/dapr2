...
In this lab, we will check the assumptions of one of the models that we have previously fitted in Block 1 where we will assess the assumptions of the multiple linear regression model we fitted using the 'mwdata' dataset in [Week 2](https://uoepsy.github.io/dapr2/2324/labs/1_02_mlr.html). 
