...
1. Specify the assumptions underlying a linear model with multiple predictors
2. Assess if a fitted model satisfies the assumptions of your model (e.g., linearity, homoscedasticity, independence, and normality)
3. Identify whether multicollinearity is present 
4. Assess the effect of influential cases on linear model coefficients and overall model evaluations (e.g., outlyingness, high leverage, high influence)
...
4. Fit the following model, and assign it the name "wb_mdl1":  
