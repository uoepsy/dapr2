...
`r optbegin("Simple Linear Regression Models - Description & Specification", olabel=FALSE,toggle=params$TOGGLE)`
...
`r optbegin("Simple Linear Regression Models - Example", olabel=FALSE,toggle=params$TOGGLE)`
...
`r optbegin("Multiple Linear Regression Models - Description & Specification", olabel=FALSE,toggle=params$TOGGLE)`
...
`r optbegin("Simple Linear Regression Models - Visualisation", olabel=FALSE,toggle=params$TOGGLE)`
...
`r optbegin("Multiple Linear Regression Models - Visualisation", olabel=FALSE,toggle=params$TOGGLE)`
...
`r optbegin("Categorical Predictors - Interpretation", olabel=FALSE,toggle=params$TOGGLE)`
...
`r optbegin("Example Data", olabel=FALSE,toggle=params$TOGGLE)`
...
`r optbegin("Extracting Information", olabel=FALSE,toggle=params$TOGGLE)`
...
knitr::include_graphics("images/recall_mdl_call.PNG")
```
...
knitr::include_graphics("images/recall_mdl_residuals.PNG")
```
...
knitr::include_graphics("images/recall_mdl_coefficients.PNG")
```
...
knitr::include_graphics("images/recall_mdl_residerror.PNG")
```
...
`r optbegin("In R - Additive Model", olabel=FALSE,toggle=params$TOGGLE)`
...
`r optbegin("Example - Additive Model", olabel=FALSE,toggle=params$TOGGLE)`
...
`r optbegin("In R - Interaction Model", olabel=FALSE,toggle=params$TOGGLE)`
...
`r optbegin("Example - Interaction Model", olabel=FALSE,toggle=params$TOGGLE)`
...
$$
\text{p} \quad = \quad \frac{e^{logit}}{1+e^{logit}} \quad = \quad \frac{e^{-1.3863}}{1+e^{-1.3863}} \quad = \quad \frac{0.25}{1.25} \quad = \quad0.2
$$
...
`r optbegin("Non-Continuous Outcomes", olabel=FALSE,toggle=params$TOGGLE)`
...
$$
\begin{align}
\frac{p}{1-p} &= b_0 + b_1 \cdot x_1 + ... + b_p \cdot x_p \\
\qquad \\
...
`r optbegin("Comparing lm() and glm() summary output", olabel=FALSE,toggle=params$TOGGLE)`
...
knitr::include_graphics("images/recall_mdl_output_f.PNG")
```
...
knitr::include_graphics("images/recall_mdl_output_r.PNG")
```
...
knitr::include_graphics("images/recall_mdl_anova_comp.PNG")
```
...
```{r mlraicbic, echo=FALSE, fig.cap="Model Comparisons using AIC and BIC", fig.align = 'left'}
knitr::include_graphics("images/recall_mdl_aic_bic.PNG")
```
...
```{r}
plot(rstandard(mallowmod, type = "deviance"), ylab = "Standardised Deviance Residuals")
```
...
`r optbegin("Cooks Distance", olabel=FALSE,toggle=params$TOGGLE)`
