...
Imagine that you were tasked to investigate whether the probability of having senility symptoms (0 = not present; 1 = present) changes as a function of Wechsler Adult Intelligence Scale (WAIS) score. 
...
+ `ymin = `: lower CI bound
+ `ymax = `: upper CI bound
+ `geom_line()`: predicted effect line (i.e., how the DV varies as a function of the IV)
...
+ Lower deviance values indicate a better fit. If you wanted to know whether the difference in deviance was *significantly* different, you would need to *statistically* compare your models (see [model comparisons - logistic models](https://uoepsy.github.io/dapr2/2526/labs/1_b4_reading.html#logistic-models)). 
