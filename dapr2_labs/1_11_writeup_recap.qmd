...
* Section A: You will answer with multiple choice questions (see Question 1 for an example)
...
Using the values below, calculate both $R^2$ and Adjusted $R^2$.
...
#| echo: false
knitr::include_graphics("images/mock_q3.png")
```
