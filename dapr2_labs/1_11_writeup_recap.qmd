...
Descriptive statistics are displayed in @tbl-scsdasstab. 
...
Bivariate correlations showed a moderate negative association between DASS-21 and SCS scores; a moderate positive association between DASS-21 and Neuroticism, and a weak positive correlation between SCS and Neuroticism (see @fig-splom). 
