...
- For reporting an unstandardised coefficient, use this template structure (filled in with nonsense values for the sake of illustration): **($b$ = 0.54, 95% CI [0.32, 0.76], $p$ = .04).**
    - For a standardised coefficient, replace $b$ with $\beta$.
- For p-values, you should report exact p-values (like $p$ = .04) unless $p$ is smaller than .001, in which case you can just write $p$ < .001.
