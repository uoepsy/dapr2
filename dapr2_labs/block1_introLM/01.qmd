...
:::red
🗂️
See [Compute model-predictded values > For sample data](https://uoepsy.github.io/dapr2/2627/flashcards/block1/model-fitted-values.html#model-predicted-values-hat-y_i-for-sample-data){target="_blank"} flash card.
:::
