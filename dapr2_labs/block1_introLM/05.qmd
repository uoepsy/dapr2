...
- 🗂️   [Analysis workflow (Block 1)](https://uoepsy.github.io/dapr2/2627/flashcards/resources/workflow-b1.html){target="_blank"}
...
`r solbegin(label='example – full write-up for RQ1', show=params$SHOW_SOLS, toggle=params$TOGGLE)`
...
`r solbegin(label='example – full write-up for RQ2', show=params$SHOW_SOLS, toggle=params$TOGGLE)`
