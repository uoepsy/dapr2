...
| $\hat{\beta}_4$ | -10 | [Mean(Amnesic, Recognition) - Mean(Amnesic, Grammar)] - [Mean(Control, Recognition) - Mean(Control, Grammar)]  = [65-60] - [95-80] = 5-15 |
| $\hat{\beta}_5$ | -10 | [Mean(Huntingtons, Recognition) - Mean(Huntingtons, Grammar)] - [Mean(Control, Recognition) - Mean(Control, Grammar)]  = [95-40] - [95-80] = 55-15 |
...
+ The difference between score in Amnesic and Control diagnosis conditions between Recognition and Grammar tasks.      - The difference between individuals in the Amnesic and Control conditions was `r round(abs(coef(cog_mdl)[5]),2)` points lower when completing the Recognition in comparison to the Grammar task.
...
+ The difference between score in Huntingtons and Control diagnosis conditions between Recognition and Grammar tasks.  
    - The difference between individuals in the Huntingtons and Control conditions was `r round(abs(coef(cog_mdl)[6]),2)` points higher when completing the Recognition in comparison to the Grammar task.
