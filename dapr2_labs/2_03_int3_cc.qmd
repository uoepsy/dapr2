...
+ The difference between score in Amnesic and Control diagnosis conditions between Recognition and Grammar tasks.  
    - The difference between individuals in the Amnesic and Control conditions was `r round(abs(coef(cog_mdl)[5]),2)` points lower when completing the Recognition in comparison to the Grammar task.
