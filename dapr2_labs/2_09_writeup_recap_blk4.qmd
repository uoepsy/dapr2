...
The `mallow2` dataset contained information on 304 participants who took part in a study concerning delayed gratification (scored dichotomously as taken or waited) - where children were presented with a single marshmallow, but were told that if they could leave it for 10 minutes, they would be rewarded with two marshmallows. The children participated in either the morning (am) or afternoon (pm), and the marshmallow was either visible or hidden for the 10 minute duration of the experiment. The age of each child was also recorded.  The sample of children also had their age recorded. All participant data was complete (no missing values).
