...
> **Research Question**
> 
> + Does the probability of delaying gratification change as a function of age, marhsmallow visibility, and time of day?
...
Age and visibility were significant predictors of delayed gratification (see @tbl-res). For every year increase in age, the odds of taking the marshmallow decreased by a factor of `r res[3,1]` ($95\%\, CI\, [`r paste(res[3,2:3],collapse=", ")`]$. When the marshmallow was hidden (as opposed to visible), the odds of taking the marshmallow decreased by a factor of `r res[4,1]` ($95\%\, CI\, [`r paste(res[4,2:3],collapse=", ")`]$
...
Our results led us to reject the null hypothesis, as the probability of children delaying gratification did change as a function of age and marshmallow visibility (but not time of day). 
...
$$
\begin{aligned}
Model_Senility}: \qquad \log \left( \frac{p}{1 - p}\right) = \beta_0 + \beta_1 \cdot \text{WAIS Score} + \epsilon
\end{aligned}
$$
