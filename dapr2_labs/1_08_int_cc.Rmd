...
:::int
The difference in scores between the recognition and grammar tasks, respectively measuring explicit and implicit memory, for Huntigton patients in comparison to controls was significant and indicated a difference of $b_5 = 40$ points in explicit vs implicit memory performance: $t(24) = 3.41, p = 0.002$.

The difference in scores between the recognition and grammar tasks, respectively measuring explicit and implicit memory, for amnesiac patients in comparison to controls was estimated to be $b_5 = -10$ points but it is not found to be significantly different from 0: $t(24) = -0.85, p = 0.40$.
