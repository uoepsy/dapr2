...
Before attempting the lab please read [Chapter 1 of Lewis-Beck by clicking this link](https://discovered.ed.ac.uk/permalink/f/gfso8q/44UOE_ALMA51187817940002466){target="_blank"}.
:::
...
_**Hint:** You could, for example, create a density plot of the variable and provide summary statistics such as the centre and standard deviation of the distribution._
`r qend()`
...
- estimated intercept $\hat \beta_0$ (some authors call it $b_0$);
- estimated slope $\hat \beta_1$ (some authors call it $b_1$);
- estimated standard deviation of the errors $\hat \sigma$ (some authors call it $s$).
...
The *fitted model*, returning the predicted average response for any value of $x$ is:
$$
