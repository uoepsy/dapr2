...
We checked the data and found that that all participant data was complete and that test scores were within a reasonable range (i.e., 0–100).
...
Specifically, we found that people who took longhand notes performed better than people who took notes on a laptop, and the advantage of taking longhand notes increased, the more time those note-takers spent studying.
