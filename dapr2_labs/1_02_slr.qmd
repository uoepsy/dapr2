...
|  <br>          | <br>                                                                                                                                                         | <br>                                                                                                                                                               |
|  <br>          | <br>                                                                                                                                                         | <br>                                                                                                                                                               |
|                | - The *shape* of the distribution. Look at the shape, centre and spread of the distribution. Is it symmetric or skewed? Is it unimodal or bimodal?           | -  The *direction* of the association indicates whether there is a positive or negative association                                                                |
|                | - Identify any *unusual observations*. Do you notice any extreme observations (i.e., outliers)?                                                              | -  The *form* of association refers to whether the relationship between the variables can be summarized well with a straight line or some more complicated pattern |
...
We performed a $t$-test against the null hypothesis that education was not associated with income. A significant association was found between level of education (in years) and income $t(30) = 7.173,\ p < .001$, two-sided. Thus, we have evidence against the null hypothesis.
