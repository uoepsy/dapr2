...
`r optbegin("Categorical Predictors - Overview", olabel=FALSE,toggle=params$TOGGLE)`
...
`r optbegin("Manual Contrasts - Rules", olabel=FALSE,toggle=params$TOGGLE)`
...
`r optbegin("Manual Contrasts - In R", olabel=FALSE,toggle=params$TOGGLE)`
...
`r optbegin("Manual Contrasts - Example", olabel=FALSE,toggle=params$TOGGLE)`
...
\\
    ...
    \quad H_1 &: \mu_\text{Western} \frac{1}{2} (\mu_\text{Versicolor} + \mu_\text{Virginica}) \\
\\ 
\end{aligned}
$$
