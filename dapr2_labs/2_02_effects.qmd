...
Music type is a categorical variable but it is encoded as a character (`<chr>`) variable rather than a factor (`<fctr>`). Let's fix this, and rename 'type' to 'Music' whilst we're at it:
...
Provide a table of descriptive statistics and visualise your data (remember to interpret your plot in the context of the study).
...
+ There are three types of music groups ($g = 3$), where there is one group for each music type: “Classical Music,” “No Music,” “Pop Music". Each group has 120 observations. 
