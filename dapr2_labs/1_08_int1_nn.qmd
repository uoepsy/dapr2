...
$$
\widehat{DASS-21 Score} = \hat \beta_0 + \hat \beta_1 \cdot SCS Score + \hat \beta_2 \cdot Neuroticism  + \hat \beta_3 \cdot (SCS Score \cdot Neuroticism) 
$$ 
...
dass_mdl <- lm(dass ~ scs*zn, data = scs_study)
