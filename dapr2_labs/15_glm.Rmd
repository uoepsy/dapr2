...
TODO rewrite based on sem2 block 1
...
In the lecture, we saw an example in which job applicants were either hired or they were not.  
```{r echo=FALSE, out.width="50%"}
knitr::include_graphics("images/glm/lecbin.png")
```
...
```{r plodd, echo=FALSE, fig.cap="Probability, Odds and Log-odds"}
...
$$
\color{red}{Y} = \color{blue}{\beta_0 \cdot{} 1 + \beta_1 \cdot{} X_1 + ... + \beta_k \cdot{} X_k} + \epsilon
$$
...
```{r resslineplot, echo=FALSE, out.width="60%", fig.cap="https://uoepsy.github.io/dapr2/lectures/dapR2_lec03_LMintro.html#24 (graph added here)"}
