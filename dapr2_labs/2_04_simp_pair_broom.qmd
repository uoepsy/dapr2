...
- If you think you'd benefit from a refresher on coding constraints, it might be best to revisit the materials from Semester 1 Block 2 (especially the  [dummy vs effects coding flashcard](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#numeric-outcomes-categorical-predictors)).  
...
For examples, see flashcards on [descriptives statistics tables - categorical and numeric values examples](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#numeric-exploration) and [categorical x categorical example - visualise data](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#categorical-x-categorical-example).    
...
For an overview, review the [multiple comparisons flashcards](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#multiple-comparisons).
