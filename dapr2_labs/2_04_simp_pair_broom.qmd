---
title: "Manual Contrast Interactions, Simple Effects, & Corrections"
link-citations: TRUE
params: 
    SHOW_SOLS: TRUE
    TOGGLE: TRUE
...
2. Have completed previous lab exercises from [Semester 1 Week 7](https://uoepsy.github.io/dapr2/2526/labs/1_06_dummy.html), [Semester 1 Week 8](https://uoepsy.github.io/dapr2/2526/labs/1_07_effects.html), [Semester 1 Week 11](https://uoepsy.github.io/dapr2/2526/labs/1_10_writeup_recap2.html), [Semester 2 Week 1](https://uoepsy.github.io/dapr2/2526/labs/2_01_int1_nc.html), [Semester 2 Week 2](https://uoepsy.github.io/dapr2/2526/labs/2_02_int2_nn.html), and [Semester 2 Week 3](https://uoepsy.github.io/dapr2/2526/labs/2_03_int3_cc.html).
...
Note, you have already worked with *some* of this data last week - see [Semester 2 Week 3 lab](https://uoepsy.github.io/dapr2/2526/labs/2_03_int3_cc.html), but we now have a third Task condition - Classification. 
...
- If you think you'd benefit from a refresher on contrast coding schemes, it might be best to revisit the materials from Semester 1 Block 2 (especially the  [dummy vs effects coding flashcard](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#numeric-outcomes-categorical-predictors)).  
- If you would like an overview of coding constraints in the context of interaction models, review the [categorical x categorical example > coding constraints flashcard](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#categorical-x-categorical-example).    
...
*See the [numeric outcomes & categorical predictors flashcard](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#numeric-outcomes-categorical-predictors).  
...
To set the reference levels as specified, the following code will do the trick:
...
- Give the reader some background on the context of the study (you might be able to re-use some of the content you wrote for [Semester 2 Week 3 lab](https://uoepsy.github.io/dapr2/2526/labs/2_03_int3_cc.html) here, but note that we now have an extra condition within Task)
...
The [statistical models](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#statistical-models) flashcards may also be useful to refer to. Specifically the [interaction models flashcards](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#interaction-models) and [categorical x categorical example flashcards](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#categorical-x-categorical-example) might be of most use.
...
For examples, see flashcards on [descriptives statistics tables - categorical and numeric values examples](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#numeric-exploration).    
...
#| tbl-cap: Descriptive Statistics of Score
cog_stats <- cog |> 
...
Visualise the data.
As a sense check, make sure the visualisation captures the same patterns you observed in the descriptive statistics you just computed.
...
For examples, see flashcards on [categorical x categorical example - visualise data](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#categorical-x-categorical-example).    
...
Since we have a continuous outcome and 2 categorical predictors - a boxplot would be appropriate for visualisations:
...
A violin plot with jittered points would also work:

```{r}
#| label: fig-cog-desc-violin
#| fig-cap: "Association between Task Condition, Diagnosis, and Score"

cog |>
    ggplot(aes(x = Diagnosis, y = Score, colour = Diagnosis, fill = Diagnosis)) +
...
- For an example, review the [interaction models > categorical x categorical example > model building flashcards](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#categorical-x-categorical-example).  
...
- For an overview and example, review the [interaction models > categorical x categorical example > model visualisation flashcards](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#categorical-x-categorical-example).   
...
## Results Table (not mandatory for this lab)
...
## Interaction Plot (not mandatory for this lab)
...
Full regression results including 95% Confidence Intervals are shown in @tbl-w4-modresults, and the interaction model is visually presented in @fig-cog-4. The $F$-test for model utility was significant $(F(8, 36) = 12.28, p < .001)$, and the model explained approximately 67% of the variability in Scores. We have evidence to reject the null hypothesis (that there are no significant differences in performance between explicit and implicit memory tasks for patients with different cognitive impairment(s)), since $\beta_6 \text{  and } \beta_8 \neq  0$. 
...
To figure out the coding values for an interaction's contrast, we need to multiply all combinations of the manual contrast's coding values together.
...
For an overview and example, review the [manual contrasts flashcards > interaction models](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#interaction-models-1).
...
Next, specify the coefficients of the comparison—that is, format the contrast for the interaction term the way that emmeans expects.
Run the contrast analysis, obtaining 95% confidence intervals for the interaction term.
...
For an overview and example, review the [interaction models > categorical x categorical example > simple effects flashcards](https://uoepsy.github.io/dapr2/2526/labs/1_b3_reading.html#categorical-x-categorical-example). 
...
+ Only in the Huntingtons group, between recognition & grammar and recognition & classification tasks  
    + left-most blue point compared to the middle pink point, and then compared to the right-most pink point  
...
+ in the recognition task, between control & amnesic   
    + left-most blue point to middle blue point   
...
+ in the grammar task, between control & amnesic  
    + left-most orange point to middle orange point  
    
+ in the grammar task, between control & huntingtons   
    + left-most orange point to right-most orange point  
    
+ in the grammar task, between amnesic & huntingtons   
    + middle orange point to right-most orange point  

+ in the classification task, between control & huntingtons   
    + left-most pink point to right-most pink point  

+ in the classification task, between amnesic & huntingtons     
    + middle pink point to right-most pink point  
