...
+ $\beta_3$ `zscs:zn` = `r round(coef(dass_mdl)[4],2)`
    ...
    - For every 1 standard deviation increase in SCS scores, the association between Neuroticism and DASS-21 scores decreases by an additional 1.83. **FIX THIS INTERPRETATION**
