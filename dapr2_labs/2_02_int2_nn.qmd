...
+ The simple slope of SCS scores when Neuroticism scores were 0 ($Z$-scored).  
...
+ The simple slope of Neuroticism when SCS scores were 0 ($Z$-scored).  
...
+ Because we are looking at a numeric x numeric interaction, we want to specify `jnplot = T` (see [this weeks lecture](XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX), slides 17-21 for a worked example).
...
+ For individuals 1 SD below the sample mean on Neuroticism, as their SCS Score increases, it appears that their DASS-21 scores increase (i.e., their wellbeing decreases)
...
+ For individuals 1 SD above the sample mean on Neuroticism, as their SCS Score increases, it appears that their DASS-21 scores decreases at an increased rate (i.e., their wellbeing increases)
...
The Johnson-Neyman technique indicated that the association between DASS-21 scores and SCS was significant when Neuroticism scores were less than 1.28 standard deviations below the mean or greater than -0.55 standard deviations above the mean.
