...
+ Denote the "best" values as $\hat \beta_0$ and $\hat \beta_1$
...
+ The estimated standard deviations of the errors is:
$$\hat \sigma = \sqrt{\frac{SS_{Residual}}{n - k - 1}} = \sqrt{\frac{\sum_{i=1}^n(y_i - \bar y)^2}{n - k - 1}}$$
