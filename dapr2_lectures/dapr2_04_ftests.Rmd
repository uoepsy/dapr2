...
+ But what if instead we wanted to ask, is a model with $x1$ and $x2$ and $x3$ as predictors, better than the model with just $x1$?
...
+ Research Question: Does personlity, here the five domains of the FFM, predict self-rated health over and above age and sex?
