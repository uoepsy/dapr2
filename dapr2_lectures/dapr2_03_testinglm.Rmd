...
+ **Based on adjusted R-squared, self-control and class interaction together explain `r round(sum_performance$adj.r.squared,3)*100`% of the variance in academic performance**
