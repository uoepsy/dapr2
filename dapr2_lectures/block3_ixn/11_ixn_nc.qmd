...
:::{.dapr2callout .fragment}
`outdoor_time`: **Specifically** when `envt = 0 = nature`, spending an additional hour outdoors is associated with an increase in wellbeing of 12.29 points.
:::

:::{.dapr2callout .fragment}
`envturban`: **Specifically** when `outdoor_time = 0` hours spent outdoors, being in an urban environment is associated with an increase in wellbeing of 20.29 points.
:::
