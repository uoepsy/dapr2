...
---
# Relationship to r
+ Standardized slope ( $b_1$ ) = correlation coefficient ( $r$ ) for a linear model with a single continuous predictor.

+ In our example, $b_{hours}$ = 0.72
...
+ $b$ is a standardized measure of the linear slope.
