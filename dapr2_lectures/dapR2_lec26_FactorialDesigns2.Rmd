---
title: "<b>Factorial Designs: Interactions </b>"
...
1. Construct models to test factorial designs. 

2. Estimate and interpreat interactions in factorial designs.

3. Visualize and probe interactions in factorial designs

4. Understand how to calculate analogous estimates to those typically reported in ANOVA analyses
...
---
# Understanding categorical interactions

USE THE CONTENT FROM RMS2_w8_InteractionHandout to do the basic going through of different aspects of an interaction plot with categorical data.
