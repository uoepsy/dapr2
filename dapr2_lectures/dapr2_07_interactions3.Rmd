...
+ Expected salary for Accounts in London is Â£50,670.
]
...
+ The difference in salary between Accounts in London and Birmingham is Â£1,980. The salary is lower in Birmingham. 
...
+ The difference in salary between Accounts and Store managers in London is Â£3,460. The salary is lower for Store Managers. 
]
...
+ The difference between salary for Accounts and Store managers between London and Birmingham, differs by Â£8,420. The difference is greater in Birmingham than in London.
]
...
+ Where 
  ...
  + $c$ (column) = number of levels of the first categorical variable.
