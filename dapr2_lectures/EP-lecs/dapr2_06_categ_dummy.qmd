...
## {{< iconify material-symbols draw-outline size=1.5em >}} Warm-up activity: Line drawing
...
{{< iconify mingcute question-fill size=1.2em >}} 
...
**{{< iconify mdi frequently-asked-questions size=1.2em >}} Now is a good time for questions! {{< iconify mdi frequently-asked-questions size=1.2em >}} **
:::
...
:::{.fragment}
**Can we reject this null hypothesis?** {{< iconify codicon thumbsup-filled size=1em >}} {{< iconify codicon thumbsdown-filled size=1em >}}
:::
:::{.fragment}
**If we care about differences between study methods, is this null hypothesis interesting?** {{< iconify codicon thumbsup-filled size=1em >}} {{< iconify codicon thumbsdown-filled size=1em >}}
:::
...
The level coded as –1 will be subtracted from the level coded as 1.

We'll test the significance of that difference.
...
**Another prediction activity, individually {{< iconify material-symbols person-rounded size=1.5em >}} and in pairs/threes {{< iconify material-symbols group-outline-rounded size=1.5em >}}.**
