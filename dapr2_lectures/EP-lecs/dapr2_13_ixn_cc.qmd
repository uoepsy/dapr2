...
:::: {}
::: {.dapr2callout}
If we know the contrast coding for two interacting categorical predictors, how do we work out the coding of the interaction predictor?
:::
::::
...
- If we have two interacting predictors, A and B, then the interaction term tells us
	- how much does the association between A and the outcome (i.e., the slope of A) change, when B increases by 1?
	- how much does the association between B and the outcome (i.e., the slope of B) change, when A increases by 1?
:::
...
- The resulting vector is the coding of the interaction.
:::
