...
| transport | road_type  | transportCyclist | road_typeCityStreet | interaction |
| --------- | ---------- | ---------------- | ------------------- | ----------- |
...
## The simple effect for `transport` for rural roads
...
## The simple effect for `transport` for city streets
...
Those simple effects would match the blue and orange slopes in this equivalent plot:
