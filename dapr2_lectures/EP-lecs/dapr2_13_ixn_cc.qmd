...
- When `transport = 0 = Motorist` and `road_type = 0 = RuralRoad`, the estimated average anxiety is 27.03.

**`transportCyclist`**

- Specifically when `road_type = 0 = RuralRoad`, being a cyclist is associated with an increase in anxiety of 0.44.

**`road_typeCityStreet`**

- Specifically when `transport = 0 = Motorist`, being on city streets is associated with an increase in anxiety of 4.89.
...
- Being a cyclist changes the association of `road_type` with `anx` by 7.76.
...
:::{.fragment}
- **Equivalently,** being on city streets changes the association of `transport` with `anx` by 7.76.
...
I'll leave those to you—good practice for working out simple effects by hand!
...
The data is exactly the same as before, plus the new category of `DualCarriageway`s.
...
1. `transportCyclist:road_typeDualCarriageway`
...
road_typeDualCarriageway                      6.02 
transportCyclist:road_typeCityStreet          7.76 
transportCyclist:road_typeDualCarriageway    14.33 
```
::::
:::
::: {.column width="40%"}
...
- For Motorists on RuralRoads (i.e., at the reference levels of `transport` and `road_type`, where all predictors = 0), the estimated average `anx` is 27.03.

**`transportCyclist`**

- Specifically at the reference level of `road_type` (RuralRoad), being a cyclist is associated with an increase in anxiety of 0.44.

**`road_typeCityStreet`**

- Specifically at the reference level of `transport` (Motorist), being on city streets is associated with an increase in anxiety of 4.89.

**`road_typeDualCarriageway`**

- Specifically at the reference level of `transport` (Motorist), being on dual carriageways is associated with an increase in anxiety of 6.02.
...
- Being a cyclist changes the association of `road_typeCityStreet` with `anx` by 7.76.
...
-  Being a cyclist changes the association of `road_typeDualCarriageway` with `anx` by about 14.33.
- So, the association of `road_type DualCarriageway` with `anx` when ...
  - `transport = 0 = Motorist` is 6.02
  - `transport = 1 = Cyclist` is 6.02 + 14.33 = 20.35


  
- **Equivalently,** being on dual carriageways changes the association of `transport` with `anx` by 14.33.
- So, the association of `transport` with `anx` when ...
  - `road_typeDualCarriageway = 0 = RuralRoad` is 0.44
  - `road_typeDualCarriageway = 1 = DualCarriageway` is 0.44 + 14.33 = 14.77
