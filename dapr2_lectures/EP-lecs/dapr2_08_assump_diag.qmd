...
## Activity: What kind of unusual data points?

[wooclap vote, a bunch of diff plots]
...
- `dfb.x`: difference between the predicted values for a predictor's slope with and without this data point (there will be one of these measures per predictor)
- `dffit`: difference between predicted values for the outcome with and without this data point
...
{{< iconify codicon thumbsup-filled size=1.5em >}} {{< iconify codicon thumbsdown-filled size=1.5em >}} &nbsp;  &nbsp; Ignore them and pretend they don't exist

<br>

{{< iconify codicon thumbsup-filled size=1.5em >}} {{< iconify codicon thumbsdown-filled size=1.5em >}} &nbsp; &nbsp; Check if they could be a mistake

<br>

{{< iconify codicon thumbsup-filled size=1.5em >}} {{< iconify codicon thumbsdown-filled size=1.5em >}} &nbsp; &nbsp; Delete them

<br>

{{< iconify codicon thumbsup-filled size=1.5em >}} {{< iconify codicon thumbsdown-filled size=1.5em >}} &nbsp; &nbsp; Mention them in your write-up

<br>

{{< iconify codicon thumbsup-filled size=1.5em >}} {{< iconify codicon thumbsdown-filled size=1.5em >}} &nbsp; &nbsp; Replace them with less extreme values

<br>

{{< iconify codicon thumbsup-filled size=1.5em >}} {{< iconify codicon thumbsdown-filled size=1.5em >}} &nbsp; &nbsp; Check how much they influence your conclusions
...
When two predictors are correlated, **they contain similar information: if you know one, you can guess the other.**
