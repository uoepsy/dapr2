...
Bootstrapping can help us get more precise estimates of the parameters.

<br>

2. Linear models can test whether a coefficient's value is different from zero because we have a measure of difference (the t value) and we know how this statistic is distributed when the H0 is true.
**If we don't know the sampling distribution of the measure we're using when the H0 is true**, then we can use bootstrapping to estimate it.
...
:::{.hcenter}
{{< iconify material-symbols square-outline size=2em >}} 
{{< iconify material-symbols kid-star-outline-sharp size=2em >}} 
{{< iconify material-symbols circle-outline size=2em >}} 
{{< iconify material-symbols change-history-outline size=2em >}} 
{{< iconify material-symbols favorite-outline size=2em >}} 
:::
...
# TODO Confidence interval refresher
