...
**{{< iconify material-symbols group-outline-rounded size=1em >}} Explain to your neighbour(s):**
...
:::{.fragment .hcenter}
**These contrasts don't address our research questions! We'll need to define our own.**
:::
...
:::{.incremental}
- {{< iconify twemoji thinking-face >}} **Does it matter which chunk is positive and which chunk is negative?** Not really. It'll change whether the difference that emmeans estimates and tests is positive or negative, but the absolute value of the number should be the same.

- {{< iconify twemoji thinking-face >}} **Can I compare more than two chunks in a single contrast?** No. This is because we're dealing with the slope of a line between two groups. If you want to compare more than two things, then you need more than one contrast.

- {{< iconify twemoji thinking-face >}} **Can I use the exact same chunk in more than one contrast?** No. Using the exact same chunk in more than one contrast is the categorical predictor equivalent of collinearity/non-independence of predictors.

- {{< iconify twemoji thinking-face >}}  **How many contrasts can I have?** If you have $k$ groups, you can have up to $k-1$ contrasts. So since we have five groups, we can have up to four contrasts.
:::
...
## TODO: is contrast orthogonal?


# {{< iconify material-symbols group-outline-rounded >}} Your turn
