---
title: "Interactions IV: <br> Manual contrasts, <br> pairwise comparisons"
editor_options: 
...
We call this "pairwise comparisons", because we're comparing groups in pairs, that is, "pairwise".
...
Turns out that most of these groups are significantly different from one another.
...
We've just run fifteen different statistical tests.
