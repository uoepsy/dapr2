...
## Analysis steps so far, in three phases
...
- Test pairwise comparisons, including corrections for multiple comparisons
...
(\beta_1 \cdot \text{medium}) +
(\beta_2 \cdot \text{study}_{\text{Minimal}}) +
(\beta_3 \cdot \text{study}_{\text{Moderate}}) +
(\beta_4 \cdot \text{study}_{\text{Extensive}}) + \\
(\beta_5 \cdot \text{medium} \cdot \text{study}_{\text{Minimal}}) +
(\beta_6 \cdot \text{medium} \cdot \text{study}_{\text{Moderate}}) +
(\beta_7 \cdot \text{medium} \cdot \text{study}_{\text{Extensive}}) +
\epsilon
$$
```
...
## Phase 3: Test pairwise comparisons, including corrections for multiple comparisons
