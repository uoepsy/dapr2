...
+ Note on the next slide, the $y$-axis is slightly different (See later slides on Standardised Residuals).
...
salary2 %>% 
  ...
  geom_point() +
  geom_smooth(method = "lm", se=F) +
  geom_point(aes(x=4, y=16), col="red") +
...
salary2 %>% 
  ...
  geom_point() +
  geom_smooth(method = "lm", se=F) +
  geom_point(aes(x=8, y=100), col="red") +
