...
+ Suppose our company also had two sites, Edinburgh and Dundee, and we wanted to see if the salaries across department differed depending on location.
...
+ The difference in salary between Accounts in Edinburgh and Dundee is £1,980. The salary is lower in Dundee. 
...
+ The difference between salary for Accounts and Store managers between Edinburgh and Dundee, differs by £8,420. The difference is greater in Dundee than in Edinburgh.
...
+ Consider our salary example:
  + We could ask does the change in difference in the effect of years of service across departments, differ dependent on whether you are based in Edinburgh or Dundee.
