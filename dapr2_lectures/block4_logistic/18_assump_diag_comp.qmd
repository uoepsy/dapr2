...
# This week's data: Logistic regression with an interaction
...
p_proAI_logodds <- effect(term = 'culture * age', mod = proAI_mdl) |>
...
In contrast, as you know, **the mathematical model formulation for logistic regression has no such error term:**
...
**What you're doing here is not easy. I hope you are proud of yourselves for all your hard work.**
