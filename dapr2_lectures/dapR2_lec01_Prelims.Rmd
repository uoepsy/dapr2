...
---
# IMPORTANT: PLEASE RE-READ THIS SLIDE REGULARLY
...
In statistics there tend to be only **guidelines**. These guidelines are not exact, and only experience with data can help a person understand how to use tools such as histograms, boxplots, and qq-plots, to get a feel for how well the data are behaving.
...
---
# Next tasks
+ If everything in this lecture made sense, nothing.
