...
--
  + **agree with the authors**; academia is a place for debate, we wont censor
--
  + **think they are perfect studies**; no study is perfect and careful critique is good practice
--
  + **think they are perfect write ups**; there are many styles with pro's and con's



---
# Example Analysis
+ Psych relevant but simple


---
# Write up
+ Structure (Methods, Analysis, Results, Discussion)
+ Formal reporting results
+ Tables
+ Figures
+ Intro APA
