...
- develop the example with a covariate
...
---
# Something linking to ANOVA
- Have a slide here that says something about this **design** terminology having a direct link to ANOVA terminology, and describes the basic idea of ANOVA. Could be done in a table. The next chunk of slides conceptually does the link with one-way ANOVA
...
+ What we will now go on to look at is...
