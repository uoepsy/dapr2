...
For the model $y = \beta_0 + \beta_1 \cdot x_1 + \beta_2 \cdot x_2 + \epsilon$, the estimate $\beta_1$ will often be reported as:  
...
> Both slope coefficients are statistically significant: the effect of recall confidence, holding age constant ($b$ = 0.9, 95% CI [0.49, 1.30], $p$ < .001), as well as the effect of age, holding recall confidence constant ($b$ = –0.34, 95% CI [–0.66, –0.02], $p$ = .041).
