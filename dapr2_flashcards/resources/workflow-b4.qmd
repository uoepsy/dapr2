...
- **Based on the outcome variable, decide whether to use regular regression or logistic regression.**
  - TODO see [Logistic regression example flash card](TODO){target="_blank"}
...
- **Check model assumptions.**
  ...
  - TODO see [Logistic regression assumptions flash card](TODO){target="_blank"}
...
- **Run diagnostics for influential observations.**
  ...
  - TODO see [Influential observations for logistic regression assumptions flash card](TODO){target="_blank"}
