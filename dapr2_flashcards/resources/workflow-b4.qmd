---
title: "LM analysis workflow (Block 4)"
---
...
- **Based on the RQ, decide whether your model requires an interaction between predictors.**
  - see [Interaction models overview flash card](https://uoepsy.github.io/dapr2/2627/flashcards/block3/overview-ixn.html){target="_blank"}
...
- **Based on the outcome variable, decide whether to use regular regression or logistic regression.**
  - see [Logistic regression example flash card](https://uoepsy.github.io/dapr2/2627/flashcards/block4/logreg-example.html){target="_blank"}
...
- **Set up categorical predictors.** (e.g., factor levels? which contrast coding scheme?)
  - see [Contrast coding flash card](https://uoepsy.github.io/dapr2/2627/flashcards/block2/contrast-coding.html){target="_blank"}
...
- **Check model assumptions.**
  ...
  - see [Logistic regression assumptions flash card](https://uoepsy.github.io/dapr2/2627/flashcards/block4/logreg-assumptions.html){target="_blank"}
...
- **Run diagnostics for influential observations.**
  ...
  - see [Influential observations for logistic regression assumptions flash card](https://uoepsy.github.io/dapr2/2627/flashcards/block4/logreg-influence.html){target="_blank"}
