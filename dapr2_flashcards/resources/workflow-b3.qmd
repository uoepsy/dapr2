---
title: "LM analysis workflow (Block 3)"
---
...
- **Set up categorical predictors.** (e.g., factor levels? which contrast coding scheme?)
  - see [Contrast coding flash card](  - see [Contrast coding flash card](https://uoepsy.github.io/dapr2/2627/flashcards/block2/contrast-coding.html){target="_blank"}
){target="_blank"}
