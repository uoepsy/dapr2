...
We can visually assess this condition through histograms, density plots, and quantile-quantile plots (QQplots) of our residuals $\epsilon$.  
...
The equal variances assumption is that the error variance $\sigma^2$ is constant across values of the predictor(s) $x_1, \dots,  x_k$, and across values of the fitted values $y$. This sometimes gets termed "Constant" vs "Non-constant" variance. This is presented visually in @fig-ncv-violate and @fig-ncv-noviolate. 
