...
> Of the two interaction terms we are testing, only the first one—the adjustment to the effect of sex for Chinstrap penguins—is significantly different from zero ($b$ = –262.9, 95% CI [–441.6, –84.2], $p$ = .004).
The other interaction (the adjustment to the effect of sex for Gentoo penguins) is not statistically significant ($b$ = 130.4, 95% CI [–19.9, 280.8], $p$ = 0.09).
Nevertheless, because the first interaction term is significant, we can reject H0.
