...
> The adjustment to the effect of flipper length for different bill lengths is significantly different from zero ($b$ = 1.20, 95% CI [0.57, 1.83], $p$ < .001).
