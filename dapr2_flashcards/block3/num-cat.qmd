...
> The first interaction term, the adjustment to the effect of mean-centered flipper length for Chinstrap penguins, is not significantly different from zero ($b$ = 1.74, 95% CI [–13.71, 17.19], $p$ = .825).
However, the second interaction term—the adjustment to the effect of mean-centered flipper length for Gentoo penguins—*is* significantly different from zero ($b$ = 21.79, 95% CI [8.14, 35.44], $p$ = .002).
We can therefore reject the H0.
